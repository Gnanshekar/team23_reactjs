    ...
    return (
        <div className="w-[25%] h-full p-2 flex-col gap-2 text-white hidden lg:flex">
            <div className="bg-[121212] h-[15%] rounded flex flex-col justify-around">
                <div className="flex items-center p-2 gap-3 pl-8 cursor-pointer">
                ...
                <div className="bg-[#121212 h-[85%] rounded ">
                    ...
                    <div>
                        ...
                        <div className="p-4 bg-[#242424] m-2 font-semibold flex flex-col items-start justify-start gap-1 pl-4 mt-4">
                            <h1>Lest findsome padcast to follow</h1>
                            <p className="font-light">We will you update new episodes</p>
                            <button className="px-4 py-1.5 bg-white text-[15px] text-black rounded-full mt-4">Browse Padcast</button>
                        </div>
                    </div>
                </div>
            </div>
